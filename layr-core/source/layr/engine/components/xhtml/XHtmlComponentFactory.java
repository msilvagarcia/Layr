...
public class XHtmlComponentFactory implements ComponentFactory {
	...
	@Override
	public Component newComponent(String name, String qName, RequestContext context) throws InstantiationException, IllegalAccessException {
		if (components.containsKey(name)) {
			Component newInstance = components.get(name).newInstance();
			newInstance.setRequestContext(context);
			return newInstance;
		}
