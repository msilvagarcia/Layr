...
public class BooleanEquationsTest {
	...
	public void grantThatMatchesAnEquation() {
		String equation = "#{age} >= 18";
		Matcher matcher = evaluator.getMatcher(ComplexExpressionEvaluator.RE_IS_EQUATION, equation);
	...
	public void grantThatNegativeEvaluatorWorks() {
		...
		assertEquals(false, evaluator.evaluateAsEquationMember(expression, layrContext));
